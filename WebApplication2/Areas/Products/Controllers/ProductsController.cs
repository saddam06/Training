...
namespace Training.Web.Areas.Products.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["ProductCategoryId"] = new SelectList(_context.Set<Category>(), "CategoryId", "CategoryName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Title,NumberOfProducts,IsEnabled,ProductCategoryId")] Product product)
        {
            ...
            ViewData["ProductCategoryId"] = new SelectList(_context.Set<Category>(), "CategoryId", "CategoryName", product.ProductCategoryId);
            return View(product);
        }
